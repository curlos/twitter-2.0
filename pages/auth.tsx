    ...
    <div className="flex h-screen w-screen">
      ...
      <div className="flex-1 flex justify-center items-center p-24">
        <div>
          ...
          <form className="my-4">
            <input className="w-full p-3 bg-black border border-[#AAB8C2] dark:border-gray-400 dark:border-gray-700 rounded-lg focus:outline-none mb-3" placeholder="Username"></input>
            <input className="w-full p-3 bg-black border border-[#AAB8C2] dark:border-gray-400 dark:border-gray-700 rounded-lg focus:outline-none mb-3" placeholder="Password"></input>
          </form>
