...
const createSafeAtom = <T>(config: {key: string, default: T}) => {
  return atom<T>({
    ...config,
...
export const newTweetModalState = createSafeAtom<boolean>({
...
export const editProfileModalState = createSafeAtom<boolean>({
...
export const searchModalState = createSafeAtom<boolean>({
  key: "searchModalState",
  default: false,
});

// This is the sidebar modal that is shown when a user clicks the "Settings" (Cog icon) on mobile.
export const sidenavState = createSafeAtom<boolean>({
  key: "sidenavState",
  default: false,
});
...
export const tweetBeingRepliedToIdState = createSafeAtom<string>({
...
export const colorThemeState = createSafeAtom<string>({
  key: "colorThemeState",
  default: 'dark'
});

// Used for editing tweets but haven't fully established this quite yet so still a work-in-progress.
export const tweetToEditState = createSafeAtom<ITweet | null>({
  key: "tweetToEditState",
  default: null
});
...
export const authModalState = createSafeAtom<boolean>({
  key: "authModalState",
  default: false,
});
...
export const editInteractionSettingsModalState = createSafeAtom<boolean>({
  key: "editInteractionSettingsModalState",
  default: false,
});

// Used to store the tweet data for editing interaction settings.
export const editInteractionSettingsTweetState = createSafeAtom<object>({
