      ...
      !loading && author ? (
        ...
        <div className="text-base p-5 border-b border-[#AAB8C2] dark:border-gray-700 w-full">
          ...
          <div className="flex justify-between">
            ...
            {/* Dropdown where different actions can be seen. */}
            <TweetDropdown tweet={{
              ...tweet,
              tweetId: id
            }} author={author} authorId={authorId} deleteTweet={deleteTweet} />
          ...
          <div className="divide-y divide-gray-500">
            ...
            {/* Row of stats for each different action: Replies, Retweets, Likes. */}
            ...
            {/* Row of different actions that can be performed on the tweet: Reply/Comment, Retweet, Like, and Bookmark. */}
